...
const artifact: SessionArtifact = {
  ...
  triage: {
    canon: [
      claim(
        "c1",
        "Sableclutch sits on the south bank of the Fousan River and handles the bulk of incoming river cargo.",
        50,
        52,
        "Sableclutch",
      ),
      claim(
        "c2",
        "Maren Dock is a warehouse foreman in Sableclutch, known for noticing trouble before it surfaces.",
        100,
        103,
        "Maren Dock",
      ),
      claim(
        "c3",
        "The Black Line Badges have begun levying an informal tax on the Sableclutch wharves.",
        200,
        204,
        "Black Line Badges",
      ),
    ...
    uncertain: [
      claim(
        "c4",
        "A player guessed the Badges answer to someone in the upper city.",
        210,
        212,
        "Black Line Badges",
      ),
  ...
  proposals: [
    {
      ...
      facts: [
        {
          claimId: "c1",
          text: "Sableclutch sits on the south bank of the Fousan River and handles the bulk of incoming river cargo.",
          citations: [{ transcript: TRANSCRIPT, start: 50, end: 52 }],
          modality: "gm-stated",
        },
        {
          claimId: "c3",
          text: "The Black Line Badges have begun levying an informal tax on the Sableclutch wharves.",
          citations: [{ transcript: TRANSCRIPT, start: 200, end: 204 }],
          modality: "gm-stated",
        },
      ],
    },
    {
      ...
      facts: [
        {
          claimId: "c2",
          text: "Maren Dock is a warehouse foreman in Sableclutch, known for noticing trouble before it surfaces.",
          citations: [{ transcript: TRANSCRIPT, start: 100, end: 103 }],
          modality: "gm-stated",
        },
      ],
    },
  ...
  entities: [
    ...
    {
      id: "e3",
      canonicalName: "Black Line Badges",
      aliases: ["Black Line Badges", "Black Line"],
      wikiPath: null,
      status: "pending",
      confidence: "low",
    },
  ...
  conflicts: [
    {
      ...
      existingStatement:
        "the power centers of the Orgs that manage it are found elsewhere",
      source: "wiki",
      sourceRef: "Geography/Calaria/Hallia/Sableclutch/index.md",
      explanation:
        "The new fact frames Sableclutch as a cargo hub, which sits in tension with the page's note that its goods' power centers lie elsewhere.",
    },
  ],
};
...
console.error(
  `Wrote dev fixture → ${SESSIONS_DIR}/through-a-song-darkly@2025-08-28.json`,
);
