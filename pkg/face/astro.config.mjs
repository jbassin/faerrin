...
// Pipeline artifacts live in the sibling caster package, in caster/out (gitignored).
const OUT_DIR = fileURLToPath(new URL("../caster/out", import.meta.url));
...
export default defineConfig({
  ...
  // The data layer reads the sibling caster pkg's out/ and src/ at build time;
  // allow Vite to read it.
  vite: {
    server: { fs: { allow: [fileURLToPath(new URL("../caster", import.meta.url))] } },
  },
});
