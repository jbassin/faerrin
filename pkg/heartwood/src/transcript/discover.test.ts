...
test('discoverTranscripts against the content transcripts dir finds 41 files (30 main, 11 side)', async () => {
  const r = await discoverTranscripts('../content/transcripts');
