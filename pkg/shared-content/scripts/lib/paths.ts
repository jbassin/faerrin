...
// Paths are derived from this file's location (shared-content/scripts/lib/paths.ts),
// so the pipeline works regardless of where the monorepo is checked out.
const here = dirname(fileURLToPath(import.meta.url))

export const sharedRoot = resolve(here, "..", "..") // pkg/shared-content
...
// Wiki content is the monorepo SSOT, hosted here in shared-content.
